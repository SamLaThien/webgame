...
const DaoKhoang = () => {
  return (
    <Container>
      <SectionTitle>⛏️ ĐÀO KHOÁNG</SectionTitle>
      <StatusContainer>
        <Status>Phí vào mỏ là 200 bạc/1 giờ.</Status>
        <Status>- Để đào khoáng đạo hữu cần có Kim Thương (sẽ mất 1 đồ bên/1h), nếu không có thì có thể thuê của hệ thống với giá 50 bạc/giờ.</Status>
        <Status>- Có nhiều hầm mỏ, hãy chọn cho mình hầm mỏ thích hợp. Tùy vận khí của bản thân sẽ đào được nhiều hay ít hoặc không đào được gì.</Status>
